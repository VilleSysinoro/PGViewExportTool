...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.objectTypeLabel.setGeometry(QRect(20, 280, 107, 20))
        font1 = QFont()
        ...
        self.objectNameComboBox.setGeometry(QRect(300, 310, 400, 26))
        ...
        self.objectNameLabel.setGeometry(QRect(300, 280, 94, 20))
        ...
        self.objectTypeComboBox.setGeometry(QRect(20, 310, 251, 26))
        ...
        self.previewLabel.setGeometry(QRect(20, 339, 69, 20))
        ...
        self.exportPushButton.setGeometry(QRect(730, 310, 201, 26))
...
"color: rgb(255, 255, 255);")
        ...
        self.noneRadioButton = QRadioButton(self.qualifierGroupBox)
        self.noneRadioButton.setObjectName(u"noneRadioButton")
        self.noneRadioButton.setGeometry(QRect(10, 30, 88, 26))
        self.noneRadioButton.setFont(font)
        self.noneRadioButton.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
...
"color: rgb(255, 255, 255);")
        ...
        QWidget.setTabOrder(self.separatorLineEdit, self.noneRadioButton)
        QWidget.setTabOrder(self.noneRadioButton, self.doubleQuotationmarkRadioButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.noneRadioButton.setText(QCoreApplication.translate("MainWindow", u"Ei mit\u00e4\u00e4n", None))
